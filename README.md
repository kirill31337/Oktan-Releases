...
**Октан** — бесплатное приложение с уведомлениями о появлении нужного топлива на АЗС. Выберите топливо, станции или места для наблюдения — Октан будет проверять данные сетей в фоне и сообщать об изменениях. Карта и радиусы помогают настроить, где следить.
